...
class Init {
	...
	public function load_assets() {
		...
		wp_register_script( 'nscu-customize-controls', $script_full_path, array( 'jquery', 'customize-controls', 'nscu-flatpicker' ), '0.0.1', true );

		// wp_register_style( 'nscu-flatpicker', NCSUCP_URL . '/third-party/flatpickr/css/flatpickr.css', array(), '4.6.13' );
		wp_register_style( 'nscu-customize-controls', $style_full_path, array( 'nscu-flatpicker' ), '0.0.1' );
	}
}
